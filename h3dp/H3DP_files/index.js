document.addEventListener('DOMContentLoaded', function() {
  ...
  const showMoreButton = document.getElementById('show-more-sims');
  const additionalDemos = document.getElementById('additional-sims');
  ...
  if (showMoreButton && additionalDemos) {
    ...
    if (buttonText) {
      buttonText.innerHTML = '<strong>Entire Simulation Results</strong>';
    }
    ...
    showMoreButton.addEventListener('click', function(e) {
      ...
      if (buttonText && buttonIcon) {
        if (isHidden) {
          buttonText.innerHTML = '<strong>Hide Simulation Results</strong>';
